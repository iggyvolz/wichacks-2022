public class AnimalData
{
    ...
    {
        { Animal.HawksbillTurtle, new AnimalData { Name = "Hawksbill Turtle", Location = "Oceans", Habitat = "Tropical Oceans and Coral Reefs", FavoriteFoods = "Jellyfish, sponges, sea anemones", Size = "30-35 inches, 90-150 lbs", FunFacts = "Known for their narrow, pointed beak", Threats = "Rising seas, pollution, loss of coral reefs", Image = UnityEngine.Resources.Load<UnityEngine.Sprite>("Hawksbill Turtle"), } },
        { Animal.AfricanForestElephant, new AnimalData { Name = "African Forest Elephant", Location = "Gabon, Republic of Congo", Habitat = "Dense Tropical Forests", FavoriteFoods = "Tree leaves and fruits", Size = "8-10 feet, 2-5 tons", FunFacts = "Can live up to 70 years", Threats = "Deforestation and Habitat Loss", Image = UnityEngine.Resources.Load<UnityEngine.Sprite>("African Forest Elephant"), } },
